...
from UltraMusic import tune, app, config, db, lang, userbot
from UltraMusic.helpers import format_exception, meval, command


@app.on_message(command(["تنفيذ"]) & filters.user(app.owner))
@app.on_edited_message(command(["تنفيذ"]) & filters.user(app.owner))
@lang.language()
