...
from UltraMusic.helpers import command, phrase_command


@app.on_message(command(["السجلات"]) & app.sudo_filter)
@lang.language()
...
@app.on_message(command(["المسجل"]) & app.sudo_filter)
@lang.language()
...
@app.on_message(phrase_command(["اعادة تشغيل"]) & app.sudo_filter)
@lang.language()
...
@app.on_message(command(["تحديث"]) & app.sudo_filter)
@lang.language()
