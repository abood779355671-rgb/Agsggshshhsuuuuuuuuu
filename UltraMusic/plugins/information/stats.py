...
# This file is part of ˹ᴜʟᴛʀᴀ ᴍᴜꜱɪᴄ˼
...
import psutil
from pyrogram import __version__, types
from pytgcalls import __version__ as pytgver

from UltraMusic import app, config, db, lang, userbot
from UltraMusic.plugins import all_modules
from UltraMusic.helpers import command


@app.on_message(command(["احصائيات"]) & ~app.bl_users)
@lang.language()
