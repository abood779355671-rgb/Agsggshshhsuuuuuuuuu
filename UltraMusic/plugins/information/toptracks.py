...
@app.on_message(phrase_command(["الأكثر تشغيلا عالميا"]) & filters.group)
...
@app.on_message(phrase_command(["الأكثر تشغيلا"]) & filters.group)
...
@app.on_message(phrase_command(["الأكثر تشغيلا للمستخدم"]) & filters.group)
