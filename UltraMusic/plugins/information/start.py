...
async def _help(_, m: types.Message):
    ...
    Displays the categorised help menu buttons. A footer note is appended
    pointing users to the /الاوامر command which lists every Arabic command
    added in phases 2 & 3 (single-word commands + multi-word phrases).
    """
    ...
    # Main help menu text + Arabic commands pointer note
    caption = m.lang["help_menu"] + "\n" + m.lang["help_arabic_cmds_note"]
...
@app.on_message(command(["الإعدادات"]) & filters.group & ~app.bl_users)
@lang.language()
